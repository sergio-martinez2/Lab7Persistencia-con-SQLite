...
public class ActividadEdicion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. Obtener referencias a tus EditText en el layout XML
        ...
        // 2. Mostrar la información del vehículo en los EditText
        ...
        // 3. Permitir al usuario editar la información y guardar los cambios
    ...
    private Vehiculo obtenerVehiculoPorId(int id) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            vehiculo = new Vehiculo(id, marca, modelo, placa, color);
